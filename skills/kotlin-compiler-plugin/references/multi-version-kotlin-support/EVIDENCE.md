...
References to the JetBrains Kotlin source tree use `kotlin/<path>` notation against tag `v2.4.20` unless noted. References to community plugins (Metro, kotlinx-rpc) are pinned to the SHAs listed at the bottom.
...
**File**: [`kotlin/compiler/compiler.version/src/org/jetbrains/kotlin/config/KotlinCompilerVersion.java:16`](https://github.com/JetBrains/kotlin/blob/v2.4.20/compiler/compiler.version/src/org/jetbrains/kotlin/config/KotlinCompilerVersion.java#L16)
...
**File**: [`kotlin/docs/backend/IR_parameter_api_migration.md:5`](https://github.com/JetBrains/kotlin/blob/v2.4.20/docs/backend/IR_parameter_api_migration.md#L5)
...
(`open` was added in 2.4.20; at 2.4.10 it was a plain `val`. Source-compatible for plugins on either side.)
...
**File**: [`kotlin/compiler/compiler.version/src/org/jetbrains/kotlin/config/KotlinCompilerVersion.java:40`](https://github.com/JetBrains/kotlin/blob/v2.4.20/compiler/compiler.version/src/org/jetbrains/kotlin/config/KotlinCompilerVersion.java#L40)
...
**Path**: [`kotlin/plugins/parcelize/parcelize-compiler/`](https://github.com/JetBrains/kotlin/tree/v2.4.20/plugins/parcelize/parcelize-compiler)

Subdirectories at v2.4.20: `parcelize.cli`, `parcelize.common`, `parcelize.k1`, `parcelize.k2`, `parcelize.backend`, `testData`, `testFixtures`, `tests` (parcelize dropped its separate `tests-gen/` in 2.4.0).
...
`SubpluginArtifact` is declared further down at [`KotlinGradleSubplugin.kt:247`](https://github.com/JetBrains/kotlin/blob/v2.4.20/libraries/tools/kotlin-gradle-plugin-api/src/common/kotlin/org/jetbrains/kotlin/gradle/plugin/KotlinGradleSubplugin.kt#L247) as an `open class` (not a `data class`):
```kotlin
