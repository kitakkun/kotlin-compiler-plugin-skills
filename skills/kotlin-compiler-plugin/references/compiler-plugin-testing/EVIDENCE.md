...
- The `tests-gen/` directory holds JUnit test classes generated by `generateTestGroupSuiteWithJUnit5` from `testData/` — the same mechanism Pattern B in guide.md exposes for standalone projects (where it lives at `compiler-plugin/test-gen/`).
