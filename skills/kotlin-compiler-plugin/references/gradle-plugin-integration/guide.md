...
Or maintain a multi-version source set (see [`multi-version-kotlin-support`](../multi-version-kotlin-support/guide.md)).

## Relation to other skills

- **Foundation** → [`compiler-plugin-bootstrap`](../compiler-plugin-bootstrap/guide.md)
- **What you're packaging** → all `fir-*` and `ir-*` skills
- **Multiple Kotlin versions** → [`multi-version-kotlin-support`](../multi-version-kotlin-support/guide.md)
