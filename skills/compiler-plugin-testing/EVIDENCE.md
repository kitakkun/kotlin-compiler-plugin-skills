...
- **File**: [`kotlin/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/directives/FirDiagnosticsDirectives.kt:40`](https://github.com/JetBrains/kotlin/blob/v2.3.21/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/directives/FirDiagnosticsDirectives.kt#L40)
- **Snippet**:
  ```kotlin
...
- **File**: [`kotlin/compiler/test-infrastructure/testFixtures/org/jetbrains/kotlin/test/directives/LanguageSettingsDirectives.kt:13`](https://github.com/JetBrains/kotlin/blob/v2.3.21/compiler/test-infrastructure/testFixtures/org/jetbrains/kotlin/test/directives/LanguageSettingsDirectives.kt#L13)
- **Snippet**:
  ```kotlin
...
- **File**: [`kotlin/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/directives/CodegenTestDirectives.kt:109`](https://github.com/JetBrains/kotlin/blob/v2.3.21/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/directives/CodegenTestDirectives.kt#L109)
- **Snippet**:
  ```kotlin
...
- **File**: [`kotlin/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/directives/CodegenTestDirectives.kt:97`](https://github.com/JetBrains/kotlin/blob/v2.3.21/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/directives/CodegenTestDirectives.kt#L97)
- **Snippet**:
  ```kotlin
...
- **File**: [`kotlin/compiler/test-infrastructure-utils/testFixtures/org/jetbrains/kotlin/codeMetaInfo/CodeMetaInfoParser.kt:11`](https://github.com/JetBrains/kotlin/blob/v2.3.21/compiler/test-infrastructure-utils/testFixtures/org/jetbrains/kotlin/codeMetaInfo/CodeMetaInfoParser.kt#L11)
- **Snippet**:
  ```kotlin
...
- Sibling directories at `parcelize-compiler/` at v2.3.21: `parcelize.backend`, `parcelize.cli`, `parcelize.common`, `parcelize.k1`, `parcelize.k2`, `testData`, `testFixtures`, `tests`, `tests-gen`.
- The `tests-gen/` directory holds JUnit test classes generated by `generateTestGroupSuiteWithJUnit5` from `testData/` — the same mechanism Pattern B in SKILL.md exposes for standalone projects (where it lives at `compiler-plugin/test-gen/`).
...
### Claim: `power-assert/` flat layout (no `power-assert-compiler/` parent)
- **Path**: `kotlin/plugins/power-assert/`
- Direct subdirectories at v2.3.21: `power-assert.backend`, `power-assert.cli`, `power-assert.embeddable`, `testData`, `testFixtures` (and `build.gradle.kts`).
- Unlike `parcelize/`, `power-assert/` has no `power-assert-compiler/` intermediary — implementation modules sit directly under the plugin root. This is the simplest layout shape used in the monorepo.

## `box(): String` runner convention

### Claim: "must return exactly `\"OK\"` to pass"
- **File**: [`kotlin/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/backend/handlers/JvmBoxRunner.kt:47`](https://github.com/JetBrains/kotlin/blob/v2.3.21/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/backend/handlers/JvmBoxRunner.kt#L47)
- **Snippet**:
  ```kotlin
...
- **File**: [`kotlin/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/backend/handlers/JvmBoxRunner.kt:310`](https://github.com/JetBrains/kotlin/blob/v2.3.21/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/backend/handlers/JvmBoxRunner.kt#L310)
- **Snippet**:
  ```kotlin
...
- **File**: [`kotlin/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/backend/handlers/JvmBoxRunner.kt:170`](https://github.com/JetBrains/kotlin/blob/v2.3.21/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/backend/handlers/JvmBoxRunner.kt#L170)
- **Snippet**:
  ```kotlin
...
- **File**: [`kotlin/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/services/SplittingModuleTransformerForBoxTests.kt:50`](https://github.com/JetBrains/kotlin/blob/v2.3.21/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/services/SplittingModuleTransformerForBoxTests.kt#L50)
- **Snippet**:
  ```kotlin
...
Note on version: the template's `gradle/libs.versions.toml` (linked snippet below) currently pins `kotlin = "2.3.20"`, while the rest of this repo standardizes on `2.3.21`. The published artifact exists at both versions, and the two abstract bases referenced later in this section are unchanged between them — verified by direct comparison:

- [`AbstractFirPhasedDiagnosticTest.kt` at v2.3.20 line 36](https://github.com/JetBrains/kotlin/blob/v2.3.20/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/runners/AbstractFirPhasedDiagnosticTest.kt#L36) and [v2.3.21 line 36](https://github.com/JetBrains/kotlin/blob/v2.3.21/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/runners/AbstractFirPhasedDiagnosticTest.kt#L36): identical signature `abstract class AbstractFirPhasedDiagnosticTest(val parser: FirParser) : AbstractKotlinCompilerWithTargetBackendTest(TargetBackend.JVM_IR)`.
- [`AbstractFirBlackBoxCodegenTest.kt` at v2.3.20 line 29](https://github.com/JetBrains/kotlin/blob/v2.3.20/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/runners/codegen/AbstractFirBlackBoxCodegenTest.kt#L29) and [v2.3.21 line 29](https://github.com/JetBrains/kotlin/blob/v2.3.21/compiler/tests-common-new/testFixtures/org/jetbrains/kotlin/test/runners/codegen/AbstractFirBlackBoxCodegenTest.kt#L29): identical declaration `abstract class AbstractFirBlackBoxCodegenTestBase(val parser: FirParser) : AbstractJvmBlackBoxCodegenTestBase<FirOutputArtifact>(FrontendKinds.FIR)`.
...
- **Test task wiring snippet**:
  ...
  ```
- This file is the authoritative reference for the system properties listed in SKILL.md Pattern B.
