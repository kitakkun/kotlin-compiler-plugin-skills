...
(Same change as in `ir-call-rewriting` — see its CHANGES.md for full context.) When inserting a call into a body, set `arguments[0]` directly rather than `dispatchReceiver = ...`.
