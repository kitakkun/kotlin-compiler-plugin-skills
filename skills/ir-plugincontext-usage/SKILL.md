...
- **Bootstrap an IR plugin** → `compiler-plugin-bootstrap`
- **Replace function calls** → `ir-call-rewriting`
- **Modify function bodies** → `ir-body-modification`
- **Generate new IR classes** → `ir-synthetic-class-generation`
- **Generate FIR-level declarations whose IR bodies you fill** → `fir-declaration-generation-extension` + IR
