...
- **Pick which classes get the supertype** → `fir-predicate-system`
- **Generate the synthesised members the new supertype demands** → `fir-declaration-generation-extension`
